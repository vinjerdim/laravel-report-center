...
class FillPermissionsForCitizen extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCitizen constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.citizen',
            'admin.citizen.index',
            'admin.citizen.create',
            'admin.citizen.show',
            'admin.citizen.edit',
            'admin.citizen.delete',
            'admin.citizen.bulk-delete',
        ]);
