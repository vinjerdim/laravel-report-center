...
class FillDefaultOfficerAndPermissions extends Migration
{
    ...
    /**
     * FillDefaultOfficerUserAndPermissions constructor.
     */
    public function __construct()
    {
        $this->guardName = config('officer-auth.defaults.guard');
    ...
    public function up()
    {
        if ($this->userClassName === null) {
            throw new RuntimeException('Officer user model not defined');
        }
        DB::transaction(function () {
            ...
            foreach ($this->users as $user) {
                ...
                if ($userItem === null) {
                    ...
                    Officer::find($userId)->addMedia(storage_path() . '/images/avatar.png')
                        ->preservingOriginal()
    ...
    public function down()
    {
        ...
        DB::transaction(function () {
            foreach ($this->users as $user) {
                ...
                if ($userItem !== null) {
                    Officer::find($userItem->id)->media()->delete();
