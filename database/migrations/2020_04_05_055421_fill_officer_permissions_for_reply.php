...
class FillOfficerPermissionsForReply extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForReply constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'officer.reply',
            'officer.reply.index',
            'officer.reply.create',
            'officer.reply.show',
            'officer.reply.edit',
            'officer.reply.delete',
            'officer.reply.bulk-delete',
        ]);
