...
@section('title', 'Login as Citizen')
	        ...
	        <div class="col-md-6 col-lg-5">
				<div class="card">
					<div class="card-block">
						<auth-form
								:action="'{{ url('/citizen/login') }}'"
								:data="{}"
								inline-template>
							<form class="form-horizontal" role="form" method="POST" action="{{ url('/citizen/login') }}" novalidate>
								{{ csrf_field() }}
								<div class="auth-header">
									<h1 class="auth-title"> Login </h1>
									<p class="auth-subtitle"> as Citizen </p>
								</div>
								<div class="auth-body">
									@include('citizen.auth.includes.messages')
